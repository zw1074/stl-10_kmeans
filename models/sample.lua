require 'nn'
l1 = torch.load('models/layer1')
l2 = torch.load('models/layer2')
l3 = torch.load('models/layer3')
--l4 = torch.load('layer4')
...
vgg:get(1).weight = l1:float()
--ConvBNReLU(64,64)
--vgg:get(5).weight = l2:float()
ConvBNReLU(64,128)
vgg:get(5).weight = l2:float()
vgg:add(MaxPooling(3,3,3,3):ceil())

ConvBNReLU(128,256)
vgg:get(9).weight = l3:float()
ConvBNReLU(256,256)
